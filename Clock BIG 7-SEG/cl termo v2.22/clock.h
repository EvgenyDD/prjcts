...
unsigned char correction, correct, corr_flag, clock_, isr_1sek_, hour[]={50,0,12,1,1,1};
unsigned char calls[12][3],calls_pin[2][3], budilnik_nomer, otsroshka_num, budilnik_play_num, fl_calls_pin;
uint16_t time_bud_pin;
